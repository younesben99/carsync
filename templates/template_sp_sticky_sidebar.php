...
<?php 
   ...
   switch ($sp_koopstatus) {
    case 'tekoop':
       ?>
<div class="sp_koopstatus_badge" style="background-color: #00b362;">Te koop
       <?php
        break;
    case 'gereserveerd':
        ?>
<div class="sp_koopstatus_badge" style="background-color: #e77524;">Gereserveerd
        <?php
        break;
    case 'verkocht':
     ?>
<div class="sp_koopstatus_badge" style="background-color: #de2c4a;">Verkocht
        <?php
        break;
    default:
        # code...
