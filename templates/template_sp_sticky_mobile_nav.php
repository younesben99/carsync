<div class="sp_sticky_mobile_nav">
    <button class="sp_smv_mail smv_wrap"><i data-feather="mail"></i> <div class="smv_text">Mailen</div></button>
    ...
    <button class="sp_smv_testrit smv_wrap"><i data-feather="calendar"></i> <div class="smv_text"><?php 
