...
#bekijkfotos:focus,#bekijkfotos:hover,#fotosluiten:focus,#fotosluiten:hover {
    outline: 0;
}

#bekijkfotos:hover,#fotosluiten:hover {
    outline: 0;
    cursor: pointer;
...
svg.feather.feather-grid,svg.feather.feather-x {
    width: 18px;
    height: 18px;
    margin-right:10px;
}
...
<div class="sluitwrap"><div class="fotosluiten" id="fotosluiten"><i data-feather="x"></i><span>Sluiten</span></div></div>
...
document.addEventListener( 'DOMContentLoaded', function () {
    ...
    jQuery(".galerij_item").on('click',function(){
        ...
        jQuery(".splide_wrap").animate( { 'opacity': '1', 'bottom' : 0 }, 300 );
    ...
    jQuery(".splide_wrap,#fotosluiten").on('click', function(e) {
        jQuery(".splide_wrap").animate( { 'opacity': '0', 'bottom' : '-100vh' }, 300 );
        setTimeout(function(){ 
