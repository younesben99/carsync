...
<script src="<?php echo get_site_url() . '/wp-content/plugins/carsync/assets/js/sp_single.js?v=1.55'; ?>"></script>
<script src="<?php echo get_site_url() . '/wp-content/plugins/carsync/assets/js/sp_contact.js?v=1.55'; ?>"></script>
<script src="<?php echo get_site_url() . '/wp-content/plugins/carsync/assets/js/sp_testrit.js?v=1.55'; ?>"></script>
<?php get_footer();
}
?>