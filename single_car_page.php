...
<script src="<?php echo get_site_url() . '/wp-content/plugins/carsync/assets/js/sp_single.js?v=1.3'; ?>"></script>
<script src="<?php echo get_site_url() . '/wp-content/plugins/carsync/assets/js/sp_contact.js?v=1.3'; ?>"></script>
<script src="<?php echo get_site_url() . '/wp-content/plugins/carsync/assets/js/sp_testrit.js?v=1.3'; ?>"></script>
<?php get_footer();
}
?>